...
// removed maximum execution time for json checker script
set_time_limit(0);
// Change the value of $url to point to the web path that contains all your JSON APIs.
$url = (strpos(php_uname(), "Linux ip-172-31-23-67 4.4.0") === 0) ? 'http://54.255.237.207/app/json': 'http://localhost/project-g8t4/app/json';
