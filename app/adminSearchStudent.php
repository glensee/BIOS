                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Search Student (Dump Student)</h5>
                            </div>
                            <div class="ibox-content">
                                <form id="searchForm" method="POST">
                                    <div class="input-group">
                                        <input type="text" placeholder="Search student" id="userid" name="userid"
                                            class="form-control input-lg" required>
                                        <div class="input-group-btn">
                                            <button class="btn btn-lg btn-primary" type="submit" name="SubmitSearch">
                                                Search
                                            </button>
                                        </div>
                                    </div>
