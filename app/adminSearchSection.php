...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Search Section (Dump Section)</h5>
                            </div>
    ...
    $("#searchForm").submit(function(e) {
        ...
        // Call POST request
        request = $.ajax({
            url: "json/section-dump.php?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwiZGF0ZXRpbWUiOiIyMDE5LTEwLTI5IDA4OjQ1OjQ2In0.3Udk97YTtixTEXkmpOMXfqlhGy1hmH7osmkxvIZHdcU&r=" +
                jsonData,
            type: "post",
        });
